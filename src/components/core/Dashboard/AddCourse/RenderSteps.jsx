...
export default function RenderSteps() {
  ...
  //agar step aur steps.id ki value same ho gai tou ese pata chalega ki hum course ki creation ki kis step me hai aur hum usse highlight kar de gae aur agar steps.id < step se then that step has done so show tick icon
  const steps = [
    {
      id: 1,
